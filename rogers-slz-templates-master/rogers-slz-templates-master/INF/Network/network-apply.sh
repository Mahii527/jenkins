...
TFVARS_FILE_4='../input-file/vpc.tfvars'
TFVARS_FILE_5='../input-file/subnet.tfvars'
TFVARS_FILE_6='../input-file/firewall.tfvars'
TFVARS_FILE_7='../input-file/peering.tfvars'
TFVARS_FILE_8='../input-file/route.tfvars'
