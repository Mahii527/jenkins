...
TFVARS_FILE_4='../input-file/sink.tfvars'
TFVARS_FILE_5='../input-file/pubsub.tfvars'
TFVARS_FILE_6='../input-file/role.tfvars'
TFVARS_FILE_7='../input-file/sa.tfvars'


PLAN_FILE='../plan-file/security-tf-plan.json'
